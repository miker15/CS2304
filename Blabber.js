...
app.get('/', (req, res) => {res.send('Blabber');});
app.listen(3000, () => console.log('listening on port 3000'));

//mongo connection
//waittime start set amount of time. calling connect when its not open yet
setTimeout(function(){mongo.connect('mongodb://mongo:127.0.0.1');}, 2000);
mongo.connection.on('error', console.error.bind(console, 'MongoDB connection error'));
mongo.connection.once('open', function() {console.log("MongoDB open");});
